...
$idregistromujeres = $_POST["idregistromujeres"];
$municipio = $_POST["municipio"];
$mes = $_POST["mes"];
$año = $_POST["año"];
$numero_mujeres = $_POST["numero_mujeres"];
//Edades
