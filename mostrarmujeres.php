...
<center>
    ...
    <table class="table table-striped" style="text-align:center;">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td style="background-color:white;"><?php echo $row['idregistromujeres'];?></td>
                ...
                <td style="background-color:white;"><?php echo $row['numero_mujeres'];?></td>
                <td style="background-color:white;"> <a type="button" class="btn btn-primary" href="vermasmujeres.php?idregistromujeres=<?php echo $row['idregistromujeres'];?>"> Ver registro </a> </td>
            </tr>
            <?php
            }
            ?>
