        ...
        <div class="card-body">
          ...
          <form action="registrarhombres.php" method="POST">
            <div class="row">
                ...
                <div class="col">
                  <input type="text" name="numero_hombres" class="form-control" placeholder="Numero de hombres">
                </div>
              </div>
            </div>
            <hr>
