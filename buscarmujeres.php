...
$registros=$conexion->query("SELECT * FROM mujeres WHERE idregistromujeres=$id");
...
<table class="table table-striped" style="text-align:center;">
    <thead>
        <br>
        <tr>
            <h4 style="padding-top:10px; font-family: 'Quicksand', sans-serif;" >Lista de registros de mujeres </h4>
        </tr>
        <br>
    </thead>
    <tbody>
        <tr>
            ...
            <td style="font-family: 'Quicksand', sans-serif;" class="table-info"><strong>Cantidad mujeres</strong></td>
        ...
        ?>
        <tr>
            <td style="background-color:white;"><?php echo $registro['idregistromujeres'];?></td>
            ...
            <td style="background-color:white;"><?php echo $registro['numero_mujeres'];?></td>
            <td style="background-color:white;"> <a type="button" class="btn btn-primary" href="vermasmujeres.php?idregistromujeres=<?php echo $registro['idregistromujeres'];?>"> Ver registro </a> </td>
        </tr>
        <?php
        }
