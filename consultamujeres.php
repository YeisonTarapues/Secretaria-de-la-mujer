...
<header>
    ...
    <div class="container">
        <div class="card">
            <br>
            <h2 style="text-align:center;">Buscar registro de mujeres</h2>
            <br><br>
            <div class="card-body">
            <form style="padding-left:200px; padding-right:200px;" action ="buscarmujeres.php" method="POST" style="text-align:center;">
                <input  class="form-control" type="text" name="id" placeholder="Ingrese el ID del registro Año/Mes/Numero del municipio">
                <br>
